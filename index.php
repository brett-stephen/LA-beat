	...
	<body>
		...
		<div class="wrap-main">
            <article class="grid_item item-1">
                <div class="header_wrapper"><h2> JoJo Mason excited for first tour opening for Meghan Patrick and james barker band </h2></div>
                <div class="article_details">
                    <div class="date">Friday, 19 January 2018 08:34</div> |
			...
			<article class="grid_item item-2"><div class="header_wrapper"><h2> Things get back into full swing this week with jazz jam and Flipfest fundraiser </h2></div>
                <div class="article_details">
                ...
                <div class="text_box">
                    ...
                    <div class="left_image">
                        ...
                        <p>
                        JAMES OLDENBURG PLAYS GIGS WITH BANDEMONIUM AND HOSTS THE JAZZ JAM AT TO OWL ACOUSTIC LOUNGE WITH HBO3. PHOTO BY RICHARD AMERY
                        </p>
                    </div>
