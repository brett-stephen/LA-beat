<?php
	$the_title = 'L.A. Beats - Music Article';
	$this_Page = "Music_Article";
    $css_style = "article";?>
	...
	<body>
		...
		<div class="wrap-main">
            <article class="grid_item item-1">
                <div class="header_wrapper"><h2> Things get back into full swing this week with jazz jam and Flipfest fundraiser </h2></div>
                <div class="article_details">
                    <div class="date">Tuesday, 16 January 2018 09:30</div> |
                ...
                <div class="text_box">
                   ...
                   Things pick up this week, beginning tonight at the Slice with a big rap show featuring Evil Ebenezer of SDK plus West Coast O and J Marsh. There will be local support from the PSychonauts, Pyke, ONTK  and JPB.
                    ...
                    <div class="right_image">
                        <img src="imgs/james-oldenburg.jpg">
                        <p>
                   ...
                   Tomorrow, Wednesday, Jan. 17,  the Slice features a special FLIPfest fundraiser with Montreal’s Duchess Says, Windsor, Ontario’s Partner and local band W.I.T.S.
                    ...
                    <p>
                    Jazz jams return to the Owl Acoustic Lounge this week as well, with HBO3 hosting the first jazz jam of the new year, Jan. 17. They have a busy week as guitarist James Oldenburg, bassist Paul Holden and drummer Brad Brouwer are also playing Casino Lethbridge this weekend with Bandemonium.
                    </p>
                    ...
                    <i> — by Richard Amery, L.a. Beat Editor</i>
